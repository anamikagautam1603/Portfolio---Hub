...
export default function RightSide() {
  return (
    <div className="md-7 overflow-hidden col-12">
      ...
      <h3 className="title h6 mt-4 text-uppercase text-muted">Work Experience</h3>
      <div className="p-1">
        <div className="d-flex justify-content-between">
          <h5 className="text-dark m-0">CRIS - UTSMobile-App</h5>
      ...
      {/* Projects */}
      <h3 className="title h6 mt-4 text-uppercase text-muted">Projects</h3>
      ...
      <div className="p-1">
        <div className="d-flex justify-content-between">
          <h5 className="text-dark m-0">Real Time Chat App</h5>
          <span className="d-flex align-items-center">
            {/* <CalenderIcon />
